...
namespace CurrentTime
{
   public class Program
   {
      ...
      public static void CaseFour()
      {
         ...
         Console.WriteLine("Конвертация Timestamp из API в DateTime: {0:yyyy-MM-dd HH:mm:ss.fff}", dateTime);
         ...
         Console.WriteLine("Конвертация Timestamp из API в DateTime: {0:yyyy-MM-dd HH:mm:ss.fff}", addMilliseconds);
      }
